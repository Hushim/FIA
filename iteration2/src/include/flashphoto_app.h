...
#ifndef ITERATION2_SRC_INCLUDE_FLASHPHOTO_APP_H_
#define ITERATION2_SRC_INCLUDE_FLASHPHOTO_APP_H_
...
class FlashPhotoApp : public BaseGfxApp {
 ...
 private:
  ...
  /** statck to store history states and update states to redo*/
  StateStack *undo_buffers_stack_;
  StateStack *redo_buffers_stack_;
...
#endif  // ITERATION2_SRC_INCLUDE_FLASHPHOTO_APP_H_
