...
#ifndef ITERATION2_SRC_INCLUDE_PIXEL_BUFFER_H_
#define ITERATION2_SRC_INCLUDE_PIXEL_BUFFER_H_
...
class PixelBuffer {
 public:
  ...
  static void BackUpPixelBuffer(PixelBuffer *copy_pixel_buffer,
...
#endif  // ITERATION2_SRC_INCLUDE_PIXEL_BUFFER_H_
