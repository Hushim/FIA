...
#ifndef ITERATION2_SRC_INCLUDE_COLOR_DATA_H_
#define ITERATION2_SRC_INCLUDE_COLOR_DATA_H_
...
class ColorData {
 public:
   ...
   */
  ColorData clamped_color(double factor, double bias) const;
...
#endif  // ITERATION2_SRC_INCLUDE_COLOR_DATA_H_
