...
#ifndef ITERATION2_SRC_INCLUDE_FILTER_BLUR_H_
#define ITERATION2_SRC_INCLUDE_FILTER_BLUR_H_
...
class FilterBlur : public Filter{
 public:
  FilterBlur(void);
  explicit FilterBlur(float amount);
...
#endif  // ITERATION2_SRC_INCLUDE_FILTER_BLUR_H_
