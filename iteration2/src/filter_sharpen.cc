 ...
 ******************************************************************************/
FilterSharpen::FilterSharpen(void) {}

FilterSharpen::FilterSharpen(float amount) {
    kernel_init(amount);
}
...
void FilterSharpen::kernel_init(float amount) {
    matrix = new SharpenKernel(amount);
    return;
}

void FilterSharpen::set_color_data(int row, int col,
