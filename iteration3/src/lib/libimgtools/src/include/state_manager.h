...
class StateManager {
 public:
 /**
  * @brief A constructor to construct StateManager 
  * and set initial values for member variables.
  */
  StateManager();
 /**
  * @brief A destructor to destroy StateManager
  */
  ~StateManager() {}
  /**
   * @brief Initilize all needed GLUI interfaces
   */
  ...
  /**
   * @brief Save the last operation applied to the canvas
   *
   */
