...
class FloatMatrix {
 public:
 /**
  * @brief A constructor to construct FloatMatrix
  */
  FloatMatrix();
 /**
  * @brief A constructor to construct FloatMatrix 
  ...
  */
   ...
   * param x represents the X coordinate of the kernel
   * param y represents the Y coordinate of the kernel
