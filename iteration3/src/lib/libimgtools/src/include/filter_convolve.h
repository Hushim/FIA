...
class FilterConvolve : public Filter {
 public:
/**
 * @brief FilterConvlve constructor. 
 * @param kernel represents the pointer used to collect information on adjacent pixels (ColorData)
 * @param a bool value represent convolve alpha
 * @return Return a FitlerConvolve object
 */
  FilterConvolve(
      Kernel *kernel,
      bool convolve_alpha);
