...
class FMotionBlur : public FilterConvolve {
 public:
 	/**
 * @brief Motion blur filter constructor. 
 * @param amount the amount to apply on the canvas
 * @param direction represent the direction of motion blur
 * @return Return a FMotionBlur object
 */
