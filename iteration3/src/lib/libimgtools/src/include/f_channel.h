...
class FChannel : public Filter {
 public:
/**
 * @brief Channel filter constructor. 
 * @param r parameter that represent the factor for red
 * @param g parameter that represent the factor for green
 * @param b parameter that represent the factor for blue
 * @return Return a FChannel object
 */
  FChannel(float r, float g, float b) : red_(r), green_(g), blue_(b) {}

/**
 * @brief Generate the ColorData of a specific pixel 
 * @param buffer parameter that represent the factor for red
 * @param x parameter that represent the coordinate X
 * @param y parameter that represent the coordinate of Y
 * @return Return a FChannel object
 */
