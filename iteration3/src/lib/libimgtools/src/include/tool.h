...
class Tool {
 public:
  /**
  * @brief A constructor to construct Tool
  */
  Tool(void);
  /**
  * @brief A pure virtual destructor to destroy Tool 
  */
  virtual ~Tool(void);
 ...
 /**
   * @brief Get the maximum smear
   * @return
   */
  int max_smear() { return max_smear_;}
 /**
   * @brief Check if should smear
   * @return
   */
 ...
 protected:
   ...
   * @param[in] background_color background color of the canvas
  ...
  /**
   * @brief Set the keep_buffer_constant to true
   */
  void set_constant(void) { keep_buffer_constant_ = true;}
  /**
   * @brief Set the maximum smear associated with parameter s
   */
  void set_smear(int s) {max_smear_ = s;}
   /**
   * @brief The definition of how tool will operate as a mask on
   * the canvas when applied
   * @param[in] maskX The X coordinate of the current mask location 
   * @param[in] maskY The Y coordinate of the current mask location
   * @param[in] tool_color The current color of the tool
   * @param buffer The buffer of pixels to apply the tool to
   * @param[in] bufferX The X coordinate of the current buffer location
   * @param[in] bufferY The Y coordinate of the current buffer location
   */
