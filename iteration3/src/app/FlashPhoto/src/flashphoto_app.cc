...
void FlashPhotoApp::InitGlui(void) {
  ...
  // io_manager_.AddFileBrowserToGLUI(imagePanel, s_gluicallback);
  // io_manager_.AddLoadStampToGLUI(imagePanel, s_gluicallback);
  // io_manager_.AddSaveCanvasToGLUI(imagePanel, s_gluicallback);
